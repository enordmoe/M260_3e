...
subtitle: "Math 260 - Applied Statistics I, Fall 2026"
format:
  html:
    math: katex
    toc: true
...
In this group project, you and your peers will conduct an analysis to address a question of interest using the statistical methods learned throughout this course. This is your opportunity to explore data and apply your learning in a creative way. But be sure to remember that the primary purpose of the project is to demonstrate mastery of the course material including inference procedures (e.g., confidence intervals and hypothesis tests) as well as R procedures and visualizations (graphs) we have studied. Your group must have **2-3 members**. You cannot work by yourself on this collaborative project.


You will have two options for the data you use:

1. **Use a dataset from the course's `math260projdata` package**. This is a curated collection of real-world datasets (e.g., `coasters`, `happiness`, `wind_projects`, `house_2022`, `volcanoes`) prepared specifically for this course. These are already cleaned and ready to use in R and fit the recommended requirements for data to use. Accessing this package is described in more detail below

2. **Collect your own data** (e.g., sports statistics from a reliable web-based source, movie information from IMDB, etc.), or use another existing dataset from R, such as those in the **Lock5Data** package or other relevant R packages.
...
This project is worth a total of 140 points broken down into several stages to help you build your investigation progressively. Below is the schedule, with a detailed explanation of each step:

| Task                                  |         Due Date         | Points |
|:--------------------------------------|:------------------------:|:------:|
| **Team Formation**                    |   Friday, Week 2        | 10 pts |
| **Proposal and Detailed Methodology** |      Friday, Week 4     | 10 pts |
| **Preliminary Data Description**      |      Wednesday, Week 7       | 10 pts |
| **Poster Plan Meeting**               |   Week 9        | 10 pts |
| **Final Poster Submission**           |    Friday, Nov 20         | 60 pts |
| **Peer Assessment at StatFest**       |    Friday, Nov 20         | 10 pts |
| **Individual Reflection Report**      |    Sunday, Nov 22         | 20 pts |
| **Peer Evaluations**                  |    Sunday, Nov 22         | 10 pts |

## Step 1: Team Formation (10 points)

**Due Friday, September 25**

Form a group of 2 or 3 students to work together on the project. Submit the names of your team members.

## Step 2: Proposal and Detailed Methodology (10 points)
...
-   **If using a math260projdata dataset**, briefly note which dataset you're using and confirm you've reviewed its documentation (variable descriptions, units, any known limitations). Minimal additional cleaning should be needed, but describe any preliminary steps you expect to prepare it for your specific analysis.
-   **If using other existing data**, explain where and how you will obtain the dataset. Describe any preparations needed for the data analysis, such as cleaning or formatting. If working with a community organization, describe the data available to you or how you plan to collect additional data.
...
-   **If conducting a survey** (not recommended), describe the population of interest, your sampling method, and include a copy of any questionnaire you intend to use. Be clear on why you chose this population, how you will obtain a random sample and how you will ensure a good response rate.
...
**During Week 9 (no later than November 13)**
...
**Due Friday, November 20** submission of your poster (24x36 inches) that includes:
...
## Step 6: Peer Assessment at StatFest (10 points)

**Due Friday, November 20**

As part of our **StatFest Extravaganza**, you will assess other groups' posters using a provided rubric. This activity will not only allow you to learn from your peers but also improve your understanding by assessing the quality of other analyses.

## Step 7: Individual Reflection Report (20 points)
...
## Step 8: Peer Evaluation (10 points)
...
-   Be clear on what each row represents — e.g., a person, a state, a measurement time, etc.
-  Avoid using data sets with repeated measures on the same individual. These require more advanced analytical models.
- Try to choose a topic your groups finds interesting or socially relevant.It helps maintain momentum and leads to more thoughtful interpretation. 


### The Course Dataset Package: `math260projdata` (recommended)

The most convenient place to find a suitable dataset is the course R package
**[math260projdata](https://github.com/enordmoe/math260projdata)** which includes 23
datasets on a variety of topics selected specifically for this project. Every dataset already meets the
data requirements above, has been cleaned and checked for data quality
problems, and comes with a help page documenting what each row represents,
every variable, and where the data came from. Topics range from movies,
music, and roller coasters to volcanoes, elections, and world happiness.

Install the package once (you will need the `remotes` package first):

``` r
install.packages("remotes")
remotes::install_github("enordmoe/math260projdata")
```

Then, in any Quarto document or R session:

``` r
library(math260projdata)

?math260projdata     # overview of all 23 datasets
?coffee              # full documentation for any one dataset
head(coffee)         # first rows
```

Browse the overview page, read the help pages for two or three datasets that
interest your group, and look at what one row represents before committing.
Choosing from the package means your dataset is pre-approved — your proposal
can focus on your research questions rather than on defending the data.

### Other Sources (require prior approval)

If your group prefers to find its own data, these are good starting points:

- [Data is Plural Archive](https://www.data-is-plural.com/archive/)
- [TidyTuesday](https://github.com/rfordatascience/tidytuesday)
- [Kaggle Datasets](https://www.kaggle.com/datasets)
- U.S. Government data portals: [data.gov](https://data.gov)
- Your own experimental data (if approved in advance)

Outside datasets often have problems — missing-value codes like `-1` or
`-9999`, repeated measures, or variables that look quantitative but aren't —
so you **must** discuss any dataset from these sources with me before
submitting a proposal to ensure it's suitable for inference using tools from
this course.
