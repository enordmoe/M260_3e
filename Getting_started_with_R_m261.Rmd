...
To install R and RStudio on your own computer, go to the site <https://posit.co/download/rstudio-desktop/> and follow the instructions in the [video here](https://kzoo-my.sharepoint.com/:v:/g/personal/eric_nordmoe_kzoo_edu/EdQTtevyBadLrYfx6ImirYQBbWRYaMUExzdu97sSrA8vvA?e=jq1Hvo). Installation instructions focus on procedures for a Mac (if you have a Windows computer, here is the URL of a recent YouTube video that demonstrates the installation of R and RStudio on a Windows computer: <https://youtu.be/YrEe2TLr3MI>). Install the most recent version of the software that is compatible with your computer which may be newer than what you see in the video. Please note that as of March 27, 2024, the latest version of R is 4.3.3 and the latest version of RStudio is 2023.12.1+402. If you have any questions at this stage, feel free to reach out to me.
