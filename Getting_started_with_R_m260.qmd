...
Prefer to follow along on video? This entire tutorial is also available as a screencast: [**click here to watch**](https://kzoo-my.sharepoint.com/:v:/g/personal/eric_nordmoe_kzoo_edu/IQBzzy-Fy1rbT6t6YA7Ia4oxAY20n91XTJY-2drs-Uc-4yQ?e=WIqn0Z). Feel free to keep this page open and pause the video as you go.
:::
...
::: callout-important
If you don't have a Windows or Mac laptop but instead use an **iPad or** **Chromebook**, please email me as soon as possible so we can set up browser-based access. That option may take a couple extra days to arrange so please let me know earlier rather than later.
:::
