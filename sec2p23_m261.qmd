...
# Section 2.2 Shape and Center {background-color="#E6F0E2"}
...
Note: There are problems with the construction of this plot under R and it is best done by hand. Note that the vertical axis label is meaningless here.

## Histogram

-   The height of each bar corresponds to the number of cases in the corresponding range of a quantiative variable.
...
|:--------------------------:|:--------------------------:|
| ![dist1](figs/shapes2.png) | ![dist2](figs/shapes1.png) |

## Shapes of Distributions

### Symmmetric bell-shaped
...
# Section 2.3 One Quantitative Variable: Measures of Spread {background-color="#E6F0E2"}
