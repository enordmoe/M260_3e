...
{{< video https://www.youtube.com/embed/6RzDMEW5omc width="640" height="480" >}}
...
Do you agree? Or can you identify counfounding variables?
...
A [2006 BMJ study](https://www.bmj.com/content/332/7546/883) found no link between frequency of use of cell phones and brain tumors.

$\implies$ Observational study or experiment?
...
-   **Matched pairs** designs:
    ...
    a.  Each participant is their own control (pre-vs-post) OR

    b.  Participants are paired and a randomly selected member of each pair gets each treatment OR

    c.  Each participant gets both treatments in a random order

## A Matched Pairs Study: Gatorade and Running  {.smaller}
