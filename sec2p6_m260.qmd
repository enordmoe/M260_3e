...
Obtain and print all predictions and residuals after fitting the model:

```{r}
#| eval: false
# fit and save the regression model with a name such as lsmod
...
::: callout-important
You can use R to get the predicted values and residuals, but be sure you know how to compute them by hand calculator using the regression equation. See the [regression help sheet](https://heroic-horse-92e142.netlify.app/regression_with_r) for more details.
:::
