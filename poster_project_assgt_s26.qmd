...
subtitle: "Math 260 - Applied Statistics I, Spring 2026"
format:
  html:
    math: katex
    toc: true
...
Some data sets would not be appropriate or would require more advanced methods. Please discuss your dataset with me before submitting a proposal to ensure it’s suitable for inference using tools from this course.
