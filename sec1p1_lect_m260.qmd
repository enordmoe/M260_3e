...
-   **Race is a Social Construct**
    -   To investigate systemic racism, we often need to categorize people by race.
    -   How do we measure the effects of systemic racism using these categories?
    -   How can we study disease risk factors across these socially constructed categories?

## Gender and Discrimination

-   **The [Gender Unicorn](https://www.transhealthsa.com/wp-content/uploads/2017/05/The-Gender-Unicorn.pdf)**
    -   To measure salary discrimination, we need to classify individuals by sex/gender.
    -   How do we accurately measure salary discrimination across diverse gender identities?
    -   How do we estimate the incidence of various medical conditions considering sex/gender differences?
