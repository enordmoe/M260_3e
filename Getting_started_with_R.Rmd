...
follow the instructions in the [video here](https://kzoo-my.sharepoint.com/:v:/g/personal/eric_nordmoe_kzoo_edu/EYuV8kj74cNBjJngEAVVDBgB5KqVRathrDBK_KPyW6mE4g?e=2J4GV9)  Installation instructions focus on procedures for a Mac (if you have a Windows computer, here is the URL of a recent YouTube video that demonstrates the installation of R and RStudio on a Windows computer:  https://youtu.be/YrEe2TLr3MI).  Install the latest version of the software that is compatible with your computer. As of March 26, 2023, the latest version of R is 4.2.3 and the latest version of RStudio is 2023.03.0+386.
